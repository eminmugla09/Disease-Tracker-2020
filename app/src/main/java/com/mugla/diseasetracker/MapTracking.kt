...
// this function get coordiantes and email from firebase and track the client.
...
// once you click the button location comes  on the map.
...
// this function shows the distance between to patient from main user.
        ...
        locations.addListenerForSingleValueEvent(object:ValueEventListener{
            ...
            override fun onDataChange(p0: DataSnapshot) {
                for (i in p0.children) {
                    ...
                    try {
                        val tracking: Tracking? = i.getValue(
                            Tracking::class.java)
