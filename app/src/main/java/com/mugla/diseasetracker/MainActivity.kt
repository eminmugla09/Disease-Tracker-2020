...
import java.util.*
// this implement shows on main page and login section
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        if(ActivityCompat.checkSelfPermission(this,Manifest.permission.ACCESS_FINE_LOCATION)!=PackageManager.PERMISSION_GRANTED &&
            ...
            //location for latitue and lonitute
    ...
    //getting location of patient who login
    private fun startNewActivity(resultCode: Int, data: Intent?) {
        if(resultCode== Activity.RESULT_OK) {
            ...
            //if login failed it will give error.
        ...
        //if login successfull then opens map and shows the location.
